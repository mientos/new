document.addEventListener('DOMContentLoaded', () => {
    ...
    // NOWY PRZYCISK ROZWIJANIA HISTORII
    ...
    // NOWE ZMIENNE DO PRZECHOWYWANIA STANU PIERWSZEJ BAJKI
    ...
    const resetToFormView = () => {
        ...
        expandStoryBtn.classList.add('hidden'); // Ukryj przycisk rozwijania
    ...
    const updateStoryContent = (data) => {
        ...
        currentRawStoryText = data.story; // Zaktualizuj surowy tekst
    ...
    const executeGeneration = async () => {
        const inputs = {
            action: 'generate', // Dodajemy akcję
        ...
        try {
            ...
            originalInputs = inputs; // Zapisz oryginalne dane wejściowe
            updateStoryContent(data);

            formSection.style.display = 'none';
            storyContainer.classList.remove('hidden');
            expandStoryBtn.classList.remove('hidden'); // Pokaż przycisk rozwijania
            isStoryVisible = true;
    ...
    const handleExpandStory = async () => {
        ...
        stopCurrentAudio(); // Zatrzymaj odtwarzanie, bo zaraz będzie nowe audio

        const payload = {
            action: 'expand',
            storyText: currentRawStoryText,
            style: originalInputs.style // Przekaż styl dla zachowania tonu
        };
        ...
        try {
            ...
            updateStoryContent(data);
            expandStoryBtn.classList.add('hidden'); // Ukryj przycisk po rozwinięciu
    ...
    expandStoryBtn.addEventListener('click', handleExpandStory); // NOWY LISTENER
