document.addEventListener('DOMContentLoaded', () => {
    ...
    // ZMIANA: Pobieramy nowe elementy z ekranu powitalnego
    ...
    // Cała reszta kodu pozostaje taka sama, ale umieszczamy ją wewnątrz funkcji initApp
    const initApp = () => {
    ...
    // ZMIANA: Główny listener dla przycisku wejścia
    enterBtn.addEventListener('click', () => {
        // Krok 1: Włącz muzykę
        backgroundMusicPlayer.play().catch(e => console.error("Błąd odtwarzania muzyki:", e));
        toggleMusicBtn.classList.add('is-playing');
        toggleMusicBtn.title = "Wyłącz muzykę w tle";

        // Krok 2: Ukryj kurtynę z efektem fade-out
        entryOverlay.classList.add('hidden');

        // Krok 3: Zainicjuj resztę logiki aplikacji
        initApp();
        
        // Krok 4: Usuń kurtynę z DOM po zakończeniu animacji, dla czystości
        setTimeout(() => {
